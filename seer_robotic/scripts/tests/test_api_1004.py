...
def test_api_1004():
    """Test API 1004 (position) on port 19204 for robot_02"""
    
    robot_ip = '192.168.0.181'
    api_port = 19204
    
    print(f"Testing API 1004 (position) on {robot_ip}:{api_port}")
    ...
    try:
        ...
        # Prepare API 1004 request using the correct protocol format
...
if __name__ == "__main__":
    print("Testing API 1004 (position) on port 19204...")
    print("=" * 50)
    
    success = test_api_1004()
    
    print("=" * 50)
    if success:
        print("✓ API 1004 test completed successfully")
    else:
        print("✗ API 1004 test failed")
